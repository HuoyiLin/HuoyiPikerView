...
{
    HYLog(@"%ld",[NSCalendar currentDateComponents].month);
    return [NSCalendar currentDateComponents].month;
}

+ (NSInteger)currentYear
{
    HYLog(@"%ld",[NSCalendar currentDateComponents].year);
    return [NSCalendar currentDateComponents].year;
}

+ (NSInteger)currentDay
{
    HYLog(@"%ld",[NSCalendar currentDateComponents].day);
    return [NSCalendar currentDateComponents].day;
}
+ (NSInteger)toLimitMonth
{
    HYLog(@"%ld",[NSCalendar currentDateComponents].month);
    return [NSCalendar currentDateComponents].month;
}

+ (NSInteger)toLimitYear
{
    HYLog(@"%ld",[NSCalendar currentDateComponents].year);
    return [NSCalendar currentDateComponents].year + 1 ;
}

+ (NSInteger)toLimitDay
{
    HYLog(@"%ld",[NSCalendar currentDateComponents].day);
    return [NSCalendar currentDateComponents].day;
}
